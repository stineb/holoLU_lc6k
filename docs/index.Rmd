...
This website contains protocols for the following purposes:

- Defining simulation protocols 
- Defining implementations of the land use forcing
- Documenting the preparation of land use model forcing files
- Analysing model outputs

Codes are available on [github](https://github.com/stineb/holoLU_lc6k).
