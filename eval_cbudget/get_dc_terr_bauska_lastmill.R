...
df_land_uptake_bauska <- get_statistics_df( df_land_uptake_bauska, 2:nruns+1 )
df_cum_land_uptake_bauska <- get_statistics_df( df_cum_land_uptake_bauska, 2:nruns+1 )
